...
namespace TheProject.Api.Controllers
{
    public class FacilityController : ApiController
    {
        ...
        [HttpGet]
        public List<MapCoordinate> GetFacilitiesByPortfolioId(int? portfolioId)
        {
            try
            {
                        ...
                        if (facility.Location != null)
                        {
                            if (facility.Location.GPSCoordinates != null)
                            {
                                MapCoordinate MapCoordinate = new MapCoordinate() {
                                    ...
                                    Description = facility.Location.StreetAddress + " " + facility.Location.Suburb + " " + facility.Location.Region,
                                };
